package seleniumbasics.session2;
...
public class Practice2 {
	/*
	 * Navigate to http://demo.guru99.com/insurance/v1/header.php Enter values in
	 * the four text boxes Select "Calculate Premium" System.out the discount and
	 * calculated premium
	 * 

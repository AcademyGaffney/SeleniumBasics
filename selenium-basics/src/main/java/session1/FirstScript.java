...
public class FirstScript {
	...
	public static void main(String[] args) {
		...
		/*
         * Finally, by quitting the driver (as we would any other resource), we close all browser
         * windows that the driver was responsible for opening and end the browser session.
         */
		driver.quit();
